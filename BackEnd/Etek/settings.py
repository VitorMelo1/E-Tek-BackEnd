...
# ALLOWED_HOSTS correto (para corrigir erro 400)
ALLOWED_HOSTS = ['e-tack.onrender.com', 'localhost', '127.0.0.1']
...
WSGI_APPLICATION = 'Etek.wsgi.application'
...
# Arquivos estáticos (essencial no Render)
STATIC_URL = '/static/'
